if game.PlaceId == 4913708314 then
  if not game.Players.LocalPlayer.Name == "lazmuri3" and game.Players.LocalPlayer.Name == "celalcan5554" and game.Players.LocalPlayer.Name == "Apoleias" and game.Players.LocalPlayer.Name == "N3mes1s_Nyks" and game.Players.LocalPlayer.Name == "OnlySploits" then
